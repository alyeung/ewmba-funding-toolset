...
## 1. Executive Summary
*   **Event Name:** Berkeley Business School Winter Gala
*   **Target Rounds:** 
...
## 3. Budget Breakdown
*(Note: Total event costs will exceed the GA funding amount. GA funds will be used strictly for compliant, non-alcoholic food and supply components. Self-funding/ticket sales will cover all other expenses including any alcoholic beverages and venue setup fees.)*

| Item | Estimated Cost | GA Funding Category | Target Funding Request |
| :--- | :--- | :--- | :--- |
| **Gala Catering (Main Food):** Organic appetizers, finger foods, and dessert station | $1,500.00 | Food & Beverage | **$1,500 (Large-Project Round)** |
| **Gala Mocktail & Soft Drink Bar:** Mocktails, juices, sodas, and compostable cups | $500.00 | Food & Beverage | **$500 (Continuing Round)** |
| **Total Requested from GA** | **$2,000.00** | | |

### Budget Compliance Notes:
1.  **Split Funding Requests:** To maximize the $2,000 semester cap without relying on Plant-Based Certification, this proposal splits the requests into a **$1,500 Large-Project Request** (submitted in the September round) and a **$500 Continuing Request** (submitted in a monthly round).
2.  **No Alcohol:** No GA funds will be used to purchase alcohol. All alcoholic beverages will be purchased through ticket sales/self-funding.
3.  **No Bottled Water:** Beverage stations will use dispensers and compostable cups.
4.  **No Banned Items:** Banned items (such as trophies, gifts, raffle prizes, customized apparel with club logos, and non-compostable cutlery) are completely excluded from this request.
...
*   [ ] **Delegates' Digest:** Event will be submitted to the UCB Delegates' Digest prior to the gala.
*   [ ] **ADA Accessibility Statement:** The required ADA compliance statement will be printed on all digital and physical marketing materials.
*   [ ] **GA Sponsor Attribution:** "Sponsored by the UCB Graduate Assembly" will be displayed on all promotional materials.
*   [ ] **Receipt Submission:** All receipts and proof of compliance will be submitted via CalLink within 30 days of the event (and before the December 31, 2026 Fall semester reclaim deadline).
